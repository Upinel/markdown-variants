...
# sed
## unicode to LaTeX
### 22. transliteration of unicode Greek
### 23. degree symbols
### 24. probably omicron means 0 in subscript
### 25. italic l
### 26. perp
### 27. times
### 28. neq
### 29. \gg \ll
## syntax conversion
### 30. lower and upper scripts
### 31. remove emphasis enclosing dollar sign math
### 32. Emphasis/quote to Math
## Cleanup
### 33-38. move 0-9.+/=- outside math into math, 6 times (this will keep "eating" math-like characters outside math into math. Sometimes it will backfire, like full-stop.)
### 39. merging consecutive dollar sign
### 40. compress repeated spaces
